...
async function checkCacheAndToggleButtonStates() {
    ...
    const bulletinKey = selectedBulletin; // UI select'ten gelen değer "bulletinNo_bulletinDate"
    const recordsRef = collection(db, 'monitoringTrademarkRecords', bulletinKey);
