...
// Bu versiyon, işlevselliği korurken görsel yapıyı da düzeltir.
...
// Ana listedeki seçilen sınıfları render eden fonksiyon
...
async function loadClass35_5ModalContent() {
    try {
                ...
                <div class="class-item" data-search-text="${(cls.classNumber + ' ' + cls.classTitle).toLowerCase()}">
                    <div class="class-header" data-class-number="${cls.classNumber}">
                        ...
                        <div class="class-header-actions">
                            <button class="select-class-btn" data-class-number="${cls.classNumber}" title="Tüm sınıfı seç/kaldır">
        ...
        // Modalın içindeki event listener'ları kur
        setupClass35_5ModalEvents();
