...
renderTrademarkApplicationForm(container) {
    // Sadece dinamik alanları temizle ve yeniden yükle
    const goodsServicesSection = document.querySelector('#goodsServicesSection .nice-classification-container');
    if (goodsServicesSection) {
        goodsServicesSection.innerHTML = `
            <!-- Burada sadece dinamik sınıf listesi ve 99. sınıf alanı oluşturulacak -->
            <div id="niceClassificationList" class="classes-list" style="height: 450px; overflow-y: auto; background: #fafafa;">
            ...
            <div class="custom-class-frame mt-4">
    ...
    // Yalnızca dinamik dinleyicileri tekrar kur
