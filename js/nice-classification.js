// nice-classification.js - Tamamen Revize Edilmiş Kod
...
        // Mevcut 35-5'i ana listeden kaldır
        removeSelectedClass("35-5");
        
        // Seçilen malları ana listeye ekle
        Object.entries(class35_5_modalSelectedItems).forEach(([code, item]) => {
...
        });
        
        // Ana 35-5'i en son ekle
        const class35_5_main = allNiceData.find(c => c.classNumber === 35).subClasses[4];
        selectedClasses["35-5"] = {
            classNum: "35",
            text: class35_5_main.subClassDescription
        };
